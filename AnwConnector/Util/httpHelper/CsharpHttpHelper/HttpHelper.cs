...
using System.Net;
using System.Text;
using AnwConnector.Util.httpHelper.CsharpHttpHelper.BaseBll;
using AnwConnector.Util.httpHelper.CsharpHttpHelper.Helper;
using AnwConnector.Util.httpHelper.CsharpHttpHelper.Item;

namespace AnwConnector.Util.httpHelper.CsharpHttpHelper
{
	public class HttpHelper
	{
		private HttpHelperBll _bll = new HttpHelperBll();

		public HttpResult GetHtml(HttpItem item)
		{
			return this._bll.GetHtml(item);
		}

		public Image GetImage(HttpItem item)
		{
			return this._bll.GetImage(item);
		}

		public HttpResult FastRequest(HttpItem item)
		{
			return this._bll.FastRequest(item);
		}
